        ...
        <div className="card-body">
          ...
          <div className="row mb-6">
            <div className="col-6">
              <div>
                ...
                <h2 id="viewtitle" className="text-center">
                  {" "}
                  {task.title}
                </h2>
              </div>
            ...
            <div className="col-6">
              <div>
                ...
                <h2 id="priority" className="text-center">
                  {" "}
                  {task.priority}
                </h2>
              </div>
          ...
          <div className="row mb-4">
            <div className="col-6">
              <div>
                ...
                <h2 id="status" className="text-center">
                  {" "}
                  {task.status}
                </h2>
              </div>
            ...
            <div className="col-6">
              <div className="form-group">
                ...
                <h2 id="deadline" className="text-center">
                  {" "}
                  {task.deadline}
                </h2>
              </div>
            ...
            <div className="col-12">
              <div className="form-group">
                ...
                <h2 id="creationDate" className="text-center">
                  {" "}
                  {date}
                </h2>
              </div>
            ...
            <div className="col-12">
              <div className="form-group">
                ...
                <h2 id="description" className="text-center">
                  {" "}
                  {task.description}
                </h2>
              </div>
          ...
          <div className="row">
            <div className="col-12 text-center">
              <a className="btn btn-warning view" href={`/edit/${task._id}`}>
                Editar
              </a>
              <button className="btn btn-danger me-2" onClick={openModal}>
                Excluir
              </button>
              <a className="btn btn-secondary view" href="/">
                Voltar
              </a>
            </div>
          </div>
